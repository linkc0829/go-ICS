...
type QueryResolver interface {
	...
	GetHistory(ctx context.Context, userID string, rangeArg int) (*models.Portfolio, error)
}
...
type Query {
  ...
  getHistory(userId: String!, range: Int!): Portfolio!
...
func (ec *executionContext) unmarshalInputCostInput(ctx context.Context, obj interface{}) (models.CostInput, error) {
	...
	for k, v := range asMap {
		...
		case "owner":
			...
			it.Owner, err = ec.unmarshalOID2ᚖstring(ctx, v)
			if err != nil {
				return it, err
			}
		case "amount":
